...
class LaporanDataExport implements FromCollection, WithHeadings
{
    ...
    public function headings(): array
    {
        ...
        return [
            ...
            'tonase', 'janjang', 'hk_panen', 'luas_cavel', 'hs_ha', 'hs_pokok', 'kunjungan', 'ha_hk', 'kg_hk', 'ton_cpo', 'ton_ker', 'ton_pko', 'ha_cavel_real',
            'cost_panen', 'cost_rawat', 'cost_kantor', 'cost_teknik', 'cost_pks', 'pdo_bi', 'pdo_sbi', 'bgt_cost_palm_produk', 'bgt_cost_palm_oil',
            'rwt_piringan_ha', 'ppt_chemist_ha', 'rwt_gawangan_man_ha', 'rwt_gawangan_chem_ha', 'pruning_ha',
        ...
        foreach ($estates as $estate) {
            foreach ($tipes as $tipe) {
                ...
                $data[] = [
                    ...
                    'pdo_sbi' => $cost->pdo_sbi ?? null,
                    'bgt_cost_palm_produk' => $cost->bgt_cost_palm_produk ?? null,
                    'bgt_cost_palm_oil' => $cost->bgt_cost_palm_oil ?? null,

                    'rwt_piringan_ha' => $upkeeps['Rwt Piringan Manual']->luas_ha ?? null,
                    'ppt_chemist_ha' => $upkeeps['PPT Chemist']->luas_ha ?? null,
                    'rwt_gawangan_man_ha' => $upkeeps['Rwt Gawangan Manual']->luas_ha ?? null,
                    'rwt_gawangan_chem_ha' => $upkeeps['Rwt Gawangan Chemist']->luas_ha ?? null,
                    'pruning_ha' => $upkeeps['Pruning']->luas_ha ?? null,
