...
<body class="text-slate-800 antialiased selection:bg-indigo-100 selection:text-indigo-900">
                        ...
                        <div class="absolute right-0 top-[105%] tooltip-table z-[100] opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-200 pointer-events-none">
                            <div class="bg-slate-800 text-slate-100 text-xs rounded-lg shadow-xl p-3 border border-slate-700">
                                ...
                                <table class="w-full text-right">
                                    ...
                                    @foreach($estates as $estate)
                                        @php $ptTk = 0; foreach($kategoriPekerja as $kat) { if(isset($dataMatrix[$estate->kode]['pekerja'][$kat])) { foreach($dataMatrix[$estate->kode]['pekerja'][$kat] as $pkj) { $ptTk += $pkj->jumlah_tk; } } } @endphp
                                        <tr class="border-b border-slate-700 last:border-0">
                                            <td class="py-1.5 text-left font-medium">{{ $estate->kode }}</td>
                ...
                <table class="modern-matrix text-sm">
                    ...
                    <tbody class="text-slate-600">
                        <tr class="bg-slate-50/50">
                            ...
                            @foreach($estates as $estate) <td class="text-right font-medium text-slate-800">{{ number_format($dataMatrix[$estate->kode]['produksi']['current']['real']->hs_ha ?? 0, 2) }}</td> @endforeach
                        ...
                        <tr class="bg-slate-50/50 row-border-strong">
                            ...
                            @foreach($estates as $estate) <td class="text-right font-medium text-slate-800">{{ number_format($dataMatrix[$estate->kode]['produksi']['current']['real']->hs_pokok ?? 0, 0) }}</td> @endforeach
                        ...
                        <tr>
                            ...
                            @foreach($estates as $estate) <td class="text-right">{{ number_format(($dataMatrix[$estate->kode]['produksi']['current']['rkb']->tonase ?? 0) / 1000, 0) }}</td> @endforeach
                        ...
                        <tr>
                            <td class="">Janjang</td>
                            @foreach($estates as $estate) <td class="text-right">{{ number_format($dataMatrix[$estate->kode]['produksi']['current']['rkb']->janjang ?? 0, 0) }}</td> @endforeach
                        ...
                        <tr>
                            <td class="">Bjr</td>
                            @foreach($estates as $estate) <td class="text-right text-slate-500">{{ number_format($dataMatrix[$estate->kode]['produksi']['current']['bjr_rkb'] ?? 0, 2) }}</td> @endforeach
                        ...
                        <tr class="row-border-strong">
                            ...
                            @foreach($estates as $estate)
                                @php
                                    $rkbJjg = $dataMatrix[$estate->kode]['produksi']['current']['rkb']->janjang ?? 0;
                                    $hsPokok = $dataMatrix[$estate->kode]['produksi']['current']['real']->hs_pokok ?? 0;
                                    $rkbJjgPkk = $hsPokok > 0 ? $rkbJjg / $hsPokok : 0;
                                @endphp
                                <td class="text-right text-slate-500">{{ number_format($rkbJjgPkk, 2) }}</td>
                            @endforeach
                            @php
                                $grkbJjg = $dataMatrix['BP-2']['produksi']['current']['rkb']->janjang ?? 0;
                                $ghsPokok = $dataMatrix['BP-2']['produksi']['current']['real']->hs_pokok ?? 0;
                                $grkbJjgPkk = $ghsPokok > 0 ? $grkbJjg / $ghsPokok : 0;
                            @endphp
                        ...
                        <tr>
                            ...
                            @foreach($estates as $estate) <td class="text-right font-bold text-slate-900">{{ number_format(($dataMatrix[$estate->kode]['produksi']['current']['real']->tonase ?? 0) / 1000, 0) }}</td> @endforeach
                        ...
                        <tr>
                            ...
                            @foreach($estates as $estate) <td class="text-right font-bold text-slate-900">{{ number_format($dataMatrix[$estate->kode]['produksi']['current']['real']->janjang ?? 0, 0) }}</td> @endforeach
                        ...
                        <tr>
                            ...
                            @foreach($estates as $estate) <td class="text-right font-medium text-slate-700">{{ number_format($dataMatrix[$estate->kode]['produksi']['current']['bjr_real'] ?? 0, 2) }}</td> @endforeach
                        ...
                        <tr class="row-border-strong">
                            ...
                            @foreach($estates as $estate)
                                @php
                                    $realJjg = $dataMatrix[$estate->kode]['produksi']['current']['real']->janjang ?? 0;
                                    $hsPokok = $dataMatrix[$estate->kode]['produksi']['current']['real']->hs_pokok ?? 0;
                                    $realJjgPkk = $hsPokok > 0 ? $realJjg / $hsPokok : 0;
                                @endphp
                                <td class="text-right font-medium text-slate-700">{{ number_format($realJjgPkk, 2) }}</td>
                            @endforeach
                            @php
                                $grealJjg = $dataMatrix['BP-2']['produksi']['current']['real']->janjang ?? 0;
                                $grealJjgPkk = $ghsPokok > 0 ? $grealJjg / $ghsPokok : 0;
                            @endphp
                        ...
                        <tr>
                            ...
                            @foreach($estates as $estate) <td class="text-right font-medium">{{ number_format(($dataMatrix[$estate->kode]['histori']['bgt_1_thn']->tonase ?? 0) / 1000, 0) }}</td> @endforeach
                        ...
                        <tr>
                            ...
                            <td class="text-center font-medium text-slate-500 border-r border-slate-100">Ton</td>
                            @foreach($estates as $estate) <td class="text-right font-medium">{{ number_format(($dataMatrix[$estate->kode]['histori']['bgt_sd_bln']->tonase ?? 0) / 1000, 0) }}</td> @endforeach
                        ...
                        <tr class="row-border-strong">
                            ...
                            <td class="text-center font-medium text-slate-500 border-r border-slate-100">Ton</td>
                            @foreach($estates as $estate) <td class="text-right font-medium">{{ number_format(($dataMatrix[$estate->kode]['histori']['sns_sd_bln']->tonase ?? 0) / 1000, 0) }}</td> @endforeach
                        ...
                        <tr class="bg-orange-100/70">
                            ...
                            @foreach($estates as $estate) <td class="text-right font-bold text-orange-900">{{ number_format(($dataMatrix[$estate->kode]['histori']['real_sd_'.($tahun-3)]->tonase ?? 0) / 1000, 0) }}</td> @endforeach
                        ...
                        <tr class="bg-emerald-100/70">
                            ...
                            @foreach($estates as $estate) <td class="text-right font-bold text-emerald-900">{{ number_format(($dataMatrix[$estate->kode]['histori']['real_sd_'.($tahun-2)]->tonase ?? 0) / 1000, 0) }}</td> @endforeach
                        ...
                        <tr class="bg-amber-100/70">
                            ...
                            @foreach($estates as $estate) <td class="text-right font-bold text-amber-900">{{ number_format(($dataMatrix[$estate->kode]['histori']['real_sd_'.($tahun-1)]->tonase ?? 0) / 1000, 0) }}</td> @endforeach
                        ...
                        <tr class="bg-slate-100/70 row-border-strong">
                            ...
                            @foreach($estates as $estate) <td class="text-right font-bold text-slate-900">{{ number_format(($dataMatrix[$estate->kode]['histori']['real_sd_'.$tahun]->tonase ?? 0) / 1000, 0) }}</td> @endforeach
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const dataProdReal = [ @foreach($estates as $estate) {{ ($dataMatrix[$estate->kode]['produksi']['current']['real']->tonase ?? 0) / 1000 }}, @endforeach ];
            const dataProdBgt = [ @foreach($estates as $estate) {{ ($dataMatrix[$estate->kode]['produksi']['current']['budget']->tonase ?? 0) / 1000 }}, @endforeach ];
            const dataProdRkb = [ @foreach($estates as $estate) {{ ($dataMatrix[$estate->kode]['produksi']['current']['rkb']->tonase ?? 0) / 1000 }}, @endforeach ];
            ...
            const dataMutu = [
                @php
                    ...
                    if($sampleEstate) {
                        foreach($kriteriaMutu as $mutu) { echo ($dataMatrix[$sampleEstate->kode]['kualitas']['real'][$mutu]->persentase ?? 0) . ','; }
                    }
                @endphp
            ];
